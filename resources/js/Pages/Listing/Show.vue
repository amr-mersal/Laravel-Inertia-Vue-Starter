        ...
        <div class="w-3/4">
            ...
            <div class="mb-6">
                <div class="flex items-end justify-between mb-2">
                    ...
                    <div v-if="canModify" class="pl-4 flex items-center">
                        <Link
                            :href="route('listing.edit', listing.id)"
                            class="bg-green-500 rounded-md text-white px-6 py-2 hover:outline outline-green-500 outline-offset-2 m-1"
                        >
                            Edit
                        </Link>
                        <button
                            @click="deleteListing"
                            type="button"
                            class="bg-red-500 rounded-md text-white px-6 py-2 hover:outline outline-red-500 outline-offset-2 m-1"
                        >
                            Delete
                        </button>
                    </div>
